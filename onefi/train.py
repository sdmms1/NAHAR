    ...
    for epoch in range(params.stop_epoch):
        ...
        with torch.no_grad():
            ...
            for i, data in enumerate(test_loader, 0):
                ...
                # print(labels, pred.shape)

            print('[Epoch: %d Test] accuracy: %.3f' % (epoch + 1, corrects / test_sz))

            if best_acc < corrects / test_sz:
                print("Save best model until now! %.2f --> %.2f" % (best_acc, corrects / test_sz))
                best_acc = corrects / test_sz
