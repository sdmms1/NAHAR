# the code is adapted from the github project: https://github.com/blackfeather-wang/ISDA-for-Deep-Networks
import torch
...
class ISDALoss(nn.Module):
    ...
    def forward(self, module, y, features, target_x, ratio):


        # y = fc(features)
        self.estimator.update_CV(features.detach(), target_x)

        isda_aug_y = self.isda_aug( module, features, y, target_x, self.estimator.CoVariance.detach(), ratio)
